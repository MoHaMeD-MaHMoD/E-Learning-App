...
import 'package:dr_mohamed_app/widgets/lesson_card.dart';
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              ((  userDataFromDB!.classtType== widget.classNumber && userDataFromDB.subjectType== widget.subjectTybe) || FirebaseAuth.instance.currentUser!.email ==
        'abdelhameedmuhammad2@gmail.com') ?

                StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance
                      .collection(widget.subjectTybe + widget.classNumber)
                ...
                const Text("Access Desnied : You Are not Subscribe")
